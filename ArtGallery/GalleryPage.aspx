...
Inherits="ArtGallery.GalleryPage" Codebehind="GalleryPage.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <asp:ListView runat="server" ID="ListView1" GroupItemCount="6" DataKeyNames="id" 
     ...
     <ItemTemplate>
         ...
         <asp:HyperLink runat="server" ID="hyp1" NavigateUrl='<%# "~/PicturePage.aspx?id=" + Eval("id").ToString() %>' ForeColor="Transparent" >
        ...
        <br />
         ...
         </asp:HyperLink></td></ItemTemplate></asp:ListView><asp:LinkButton runat="server" 
                ID="btnViewAll" Text="View All" onclick="btnViewAll_Click" /><asp:ObjectDataSource  ID="ObjectDataSource1" runat="server" 
                OldValuesParameterFormatString="original_{0}" SelectMethod="GetByGalleryIdPublic" 
                TypeName="ArtGallery.PictureDL">
                 <SelectParameters>
                            <asp:QueryStringParameter Name="Galleryid" QueryStringField="id"  Type="Int32" />
                </SelectParameters>
        </asp:ObjectDataSource>
</asp:Content>
