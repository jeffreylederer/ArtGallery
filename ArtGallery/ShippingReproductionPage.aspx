...
the buy button, you will be taken to a secure PayPal page to obtain you credit card information.<br />
                <br />
            </div>
        </div>
        <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlShipping" runat="server">
                                            ...
                                            <asp:ListItem Selected="True" Value="10" >Media Mail (7 days)</asp:ListItem>
                                            <asp:ListItem Value="20">Priority Mail (2 days) </asp:ListItem>
                                            <asp:ListItem Value="03">UPS Ground</asp:ListItem>
                                            <asp:ListItem Value="01">UPS Next Day Air</asp:ListItem>
                                            <asp:ListItem Value="02">UPS Second Day Air</asp:ListItem>
                                       </asp:DropDownList>
                                ...
                                <ItemTemplate>
                                    <table cellpadding="1px" cellspacing="2px">
                                        <tr>
                                            ...
                                            <td align="right">
                                                <asp:Label runat="server" ID="lblPrice" Text='<%# Eval("price", "{0:c2}") %>' />
                                            </td>
                                        </tr>

                                        <tr>
                                            <td align="right">Handling
                                            </td>
                                            <td align="right">
