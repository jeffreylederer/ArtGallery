...
the buy button, you will be taken to a secure PayPal page to obtain you credit card information.
</td>
</tr>
...
<td><asp:Label runat="server" ID="lblTitle"  />
</td>
</tr>
...
<td><asp:Label runat="server" ID="lblDescription"  />
</td>
</tr>
...
<tr>
<td align="right">
Shipping Method<cc3:Popup runat="server" ID="puShipping" Key="LocalPickup" />:
</td>
<td>
        ...
        <asp:UpdatePanel ID="up2" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <asp:FormView ID="fv" runat="server">
                   ...
                   <td align="right"><asp:Label runat="server" ID="lblPrice" Text='<%# Eval("amount", "{0:c2}") %>' />
                   </td>
                   </tr>
                   ...
                   <td align="right"><asp:Label runat="server" ID="Label1" Text='<%# Eval("handling", "{0:c2}") %>' />
                   </td>
                   </tr>
                   ...
                   <td align="right"><asp:Label runat="server" ID="Label2" Text='<%# Eval("shipping", "{0:c2}") %>' />
                   </td>
                   </tr>
                   ...
                   <td align="right"><asp:Label runat="server" ID="Label3" Text='<%# Eval("tax", "{0:c2}") %>' />
                   </td>
                   </tr>
                   ...
                   <td align="right"><asp:Label runat="server" ID="Label4" Text='<%# Eval("total", "{0:c2}") %>' />
                   </td>
                   </tr>
                   </table>
                   </ItemTemplate>
