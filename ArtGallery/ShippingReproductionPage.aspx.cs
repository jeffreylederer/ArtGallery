...
{
    public partial class ShippingReproductionPage : System.Web.UI.Page
    {
        ...
        private bool GenerateInvoice(int id, ArtGalleryDS.ReproductionRow row)
        {
        ...
        {
            int id = int.Parse( Request.QueryString["id"] );
            ReproInfo ReproInfo = new ReproInfo();
            var row = ReproductionDL.GetById( id )[0];
