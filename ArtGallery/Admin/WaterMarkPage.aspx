<%@ Page Title="Setup WaterMark" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WaterMarkPage.aspx.cs" Inherits="ArtGallery.WaterMarkPage" %>
 ...
 EnableViewState="false" ForeColor="Red" />
    <cc1:TPMSFormView ID="TPMSFormView1" runat="server" DataKeyNames="lastupdated" 
        ...
        <EditItemTemplate>
            ...
            <td align="right">
             Text:<td>
            <asp:TextBox ID="WatermarkTextTextBox" runat="server" 
            ...
            <td align="right">
            Font Family:<td>
            <asp:TextBox ID="WatermarkFontFamilyTextBox" runat="server" 
            ...
            <td align="right">
            Font Color:<td>
            <asp:TextBox ID="WatermarkFontColorTextBox" runat="server" 
            ...
            <td align="right">
            Font Size:<td>
            <asp:TextBox ID="WatermarkFontSizeTextBox" runat="server" 
